...
**Utiliser des patterns:** Vous pouvez également spécifier des plages plus grandes de dossiers et de fichiers aux caractères spéciaux de patterns (combinables):
